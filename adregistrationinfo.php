...
<body>
    ...
    <?php
    $cimg = addslashes(strip_tags($row['certificateimgName']));
    echo "<h6>Certificate Image: <a href=userimage/".$cimg." target=_blank> Click Here</a></h6>";
    ?>

    <div class="row">
    <?php echo"<a href=actions/acceptaction.php?id=".$id."><button type='submit' class='btn btn-outline-primary margins'>Accept</button></a>";
    echo"<a href=actions/rejectaction.php?id=".$id."><button type='submit' class='btn btn-outline-danger margins2'>Reject</button></a>" ?>
    </div><br><br> 
    </div>
