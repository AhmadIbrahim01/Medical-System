...
<body>
    ...
    <h6>Taked Date: <?php echo $row['takedDate']; ?></h6>
    <h6>Organization Username: <?php echo $row['orgusername']; ?></h6>
    <h6>Sold By Pharmacy Username: <?php echo $row['givenByUser']; ?></h6>
    <h6>Status: <?php echo $row['status']; ?></h6>
    <h6>Medicines: <?php echo $row['medicines']; ?></h6><br>
    <h6>Dosage & Usage: <?php echo $row['dosage']; ?></h6><br><br>

    <div class="row">
    <?php   echo"<a href=pharpatientfile.php?user=$user><button type='submit' class='btn btn-outline-primary margins'>Back</button></a>"; ?>
    </div><br><br> 
    </div>
